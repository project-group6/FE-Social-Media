      ...
      <div className="bg-white shadow-md shadow-gray-300 rounded-md mb-5 w-4/5 p-4">
        ...
        <div>
          <p className="my-3 text-sm">
            ...
            veritatis minima porro perspiciatis, modi quas ex repellendus alias
            rerum, aliquam unde, facilis itaque eaque exercitationem. Laboriosam
            quam repellat temporibus dolores!
          </p>
